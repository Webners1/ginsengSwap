...
const abi3 = IUniswapV2PairJson
const { abi: IUniswapV2Router02ABI } = IUniswapV2Router02Json
const { abi: QuoterABI } = QuoterJson
const { abi: QuoterV2ABI } = QuoterV2Json
const { abi: TickLensABI } = TickLensJson
const abi2 = UniswapInterfaceMulticallJson
const abi = NonfungiblePositionManagerJson
...
export function usePairContract(pairAddress?: string, withSignerIfPossible?: boolean): Contract | null {
  return useContract(pairAddress, abi3.abi, withSignerIfPossible)
}
...
export function useInterfaceMulticall() {
  return useContract<UniswapInterfaceMulticall>(MULTICALL_ADDRESS, abi2.abi, false) as UniswapInterfaceMulticall
}
