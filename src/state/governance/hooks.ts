...
import abi2  from '@uniswap/governance/build/GovernorAlpha.json'
import abi3 from '@uniswap/governance/build/Uni.json'
...
function useGovernanceV0Contract(): Contract | null {
  return useContract(GOVERNANCE_ALPHA_V0_ADDRESSES, abi2.abi, false)
}

function useGovernanceV1Contract(): Contract | null {
  return useContract(GOVERNANCE_ALPHA_V1_ADDRESSES, abi2.abi, false)
}
...
function useUniContract() {
  ...
  return useContract(uniAddress, abi3.abi, true)
}
...
const GovernanceInterface = new Interface(abi2.abi)
